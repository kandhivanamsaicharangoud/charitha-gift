...
# Convert image files to Base64 so they can be displayed inside HTML
...
if not os.path.exists(photo1_path):
    st.error(f"Photo not found: {photo1_path}")
    st.stop()

if not os.path.exists(photo2_path):
    st.error(f"Photo not found: {photo2_path}")
    st.stop()


# Convert photos to Base64
photo1 = get_image_base64(photo1_path)
photo2 = get_image_base64(photo2_path)
